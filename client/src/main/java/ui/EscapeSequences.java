...
public class EscapeSequences {
    ...
    public static final String SET_TEXT_COLOR_CREME = SET_TEXT_COLOR + "222m";
    ...
    public static final String SET_BG_COLOR_CREME = SET_BG_COLOR + "222m";

    public static final String SET_BG_COLOR_BROWN = SET_BG_COLOR + "95m";
